const welcome = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <style type="text/css">
         ...
         img[class=banner] {width: 440px!important;height:313.13px!important;}
         ...
         img[class=banner] {width: 280px!important;height:199.26px!important;}
...
<table width="100%" bgcolor="#8290ff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="banner">
   <tbody>
      <tr>
         <td>
                           ...
                           <tbody>
                              <tr>
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <img width="600" border="0" height="427" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="http://elpublicamaleon.com/images/ilustracion-hero.png" class="banner">
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                          ...
                                          <tr>
                                             <td>
                                                <table width="290" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                   <tbody>
                                                      <tr>
                                                         <td width="270" height="229" align="center" class="devicewidth">
                                                            <img src="http://elpublicamaleon.com/images/ilustracion-01.png" alt="" border="0" width="270" height="229" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td>
                                          ...
                                          <tr>
                                             <td>
                                                <table width="290" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                   <tbody>
                                                      <tr>
                                                         <td width="270" height="228" align="center" class="devicewidth">
                                                            <img src="http://elpublicamaleon.com/images/ilustracion-02.png" alt="" border="0" width="270" height="228" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td>
                        ...
                        <table width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                           <tbody>
                              <tr>
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <img width="149" border="0" height="40" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="http://elpublicamaleon.com/images/logo-negro.png" >
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                  ...
                  <tr>
                     <td width="100%">
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              <tr>
                                 <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; text-align:left; font-size: 12px;color: #000000" st-content="postfooter">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sed neque eu nisi elementum ultrices placerat in purus. Nunc molestie commodo dapibus. Donec purus ex, faucibus et diam sit amet, ultricies laoreet enim. Suspendisse potenti. Cras lacinia mi nec augue vestibulum rhoncus. Nulla interdum feugiat est in feugiat. Vestibulum ut arcu tempus, mattis mauris vitae, dictum elit. Suspendisse volutpat est at quam consectetur tempor.
                                 </td>
                              </tr>
                              <tr>
                                 <td width="100%" height="20"></td>
